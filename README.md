...
Os formulários são demonstrativos e não enviam dados para um servidor real. O método POST evita expor os campos na URL, mas a proteção durante a transmissão depende do uso de HTTPS e de controles adequados no servidor.
...
- [Email](mailto:matheusdeccampos@gmail.com)
